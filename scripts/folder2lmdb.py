...
def folder2lmdb(dpath, name="train", write_frequency=5000):
    ...
    db = lmdb.open(lmdb_path, subdir=isdir,
                   map_size=1024 * 1024 * 1024, readonly=False,
...
if __name__ == "__main__":
    # generate lmdb
    folder2lmdb("C:\\Users\\pw\\projects\\datasets\\ImageNet\\imagenet", name="val")
    folder2lmdb("C:\\Users\\pw\\projects\\datasets\\ImageNet\\imagenet", name="train")
